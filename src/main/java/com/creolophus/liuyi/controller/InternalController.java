...
@Validated
@RestController
@RequestMapping(value = "/liuyi/internal", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
public class InternalController extends AbstractController {
    ...
    public ApiResult hello() {
        String msg = "Inter Kubernetes,I am liuyi-ms-k8s-provider " + System.currentTimeMillis();
